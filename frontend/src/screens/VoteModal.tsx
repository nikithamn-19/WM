...
export const VoteModal: React.FC<VoteModalProps> = ({
  ...
  const proposal: Proposal = item?.activeProposal || {
    ...
    proposedByUserId: 'usr_owner',
    proposedByDisplayName: 'Alex Chen',
    action: 'add',
    entityType: item?.entityType || 'poi',
    entityId: item?.entityId || 'poi_batur',
    title: item?.title || 'Mount Batur Trek',
    rationale: 'Sunrise trek to active volcano for panoramic views',
    costDelta: item?.cost || '65.00',
    ...
    votes: [
      {
        ...
        value: 'no',
        comment: 'Prefer hot springs spa due to knee injury',
